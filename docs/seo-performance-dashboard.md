...
| URL (/blogs/…) | Primary keyword | Pos | Impr | Clicks | CTR | Organic traffic | Conversion opportunity | Internal links (in/out) | Last updated | Next review | Priority | Notes |
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| medicare-advantage-vs-medicare-supplement-plans-in-florida… | medicare advantage vs medicare supplement florida | 17 | 4,068 | 0 | 0% | ⬜ GA4 | High — decision-stage readers; consultation CTA | 8 in / 9 out | Jul 13 2026 | Aug 9 | **95** | Top asset. FAQ schema + typo fix (Jul 9); answer-first opening + inbound links from MA-vs-Medigap pillar, turning-65, medicare-in-miami, UHealth post (Jul 13). Watch for page-1 break |
| whats-the-difference-between-medigap-plan-g-vs-plan-n-in-florida | medigap plan g vs plan n florida | 18–23 | 89 | 0 | 0% | ⬜ | High — plan-selection intent | 3 in / 8 out | Jul 9 2026 | Aug 9 | **88** | Quick-answer + 2026 table + FAQ schema shipped. Feeds future Plan G/N pillars |
| why-a-medicare-agent-near-me-may-be-better-than-insurance-comparison-websites | medicare agent near me | **8** | 4 | 0 | 0% | ⬜ | Very high — commercial intent | 2 in / 6 out | Jul 9 2026 | Aug 9 | **86** | Page 1 already. FAQ schema + related links shipped; CTR is the lever now |
| which-medicare-plan-is-better-for-dental-and-vision-coverage | dental and vision plans for seniors on medicare | 76 | 1,411 | 0 | 0% | ⬜ | High — benefit-shopping intent | 2 in / 7 out | Jul 9 2026 | Aug 9 | **84** | Stale $185 fixed → $202.90. Biggest position headroom on the site |
| how-does-medicare-advantage-compare-to-medigap-for-travel-coverage | medicare advantage vs medigap travel | 23 | 80 | 0 | 0% | ⬜ | High — snowbird niche | 2 in / 8 out | Jul 9 2026 | Aug 9 | **80** | Near page 1; FAQ schema shipped; strongest FL differentiator |
| the-hidden-benefits-of-health-insurance-you-may-not-be-using | hidden health insurance benefits | 7 | 3 | 0 | 0% | ⬜ | Medium — awareness → plan review CTA | 2 in / 5 out | Jul 9 2026 | Aug 9 | **68** | Expanded 240→750 words + MA benefits section + FAQ schema |
...
|---|---|---|---|---|---|---|---|---|
| uhealth-preferred-care-network-options-before-september-2026 | uhealth preferred care network options / medicare supplement uhealth | — new | 0 | 0 | **Jul 24 2026** | **Jul 31 (weekly)** | **90** | Follow-up "decision companion" post from Steve's transcript + 5 real inquiries. Continuity of care, SEP/C-SNP rules (verified), Aetna+Baptist dual-network insight, Medigap path. Cross-linked from first UHealth post. 3 heading widows fixed. ⚠️ Same-day update on any deal/Sept 1. ⚠️ Steve to request GSC indexing. |
| uhealth-preferred-care-network-out-of-network-sept-2026 | uhealth preferred care network out of network | — new | 0 | 0 | Jul 13 2026 (**updated Jul 24**: accuracy fix — PCN date confirmed as separate track from Jul 31 negotiation per UHealth's updated FAQ; +cross-link to options post; 1 widow fixed) | **Jul 31 (weekly)** | **90** | News post, sourced from UHealth 6/23 statement + UHC 7/13 broker comm. Expanded Jul 13 with UHealth-sourced plan-alternatives table (Aetna/Humana/Solis/Optimum/Freedom/Prominence + UM primary-care distinction) — unique data, evergreen "which plans include uhealth" target. TPMO disclaimer live (16 orgs/73 products). 7 FAQs in schema. Visible editor's note discloses the Jul 24 correction (YMYL transparency). ⚠️ UPDATE SAME-DAY if agreement announced or Sept 1 passes. ⚠️ Steve to send URL to FMO marketing-compliance re: carrier naming. GSC indexing requested Jul 13 — verify indexed. Follow-up post + local-press pitch opportunity when dispute resolves |
...
| URL | Pos | Impr | Priority | Planned action |
|---|---|---|---|---|
| /medicare-coverage/medicare-supplement-plans-medigap | 65 | 1,320 | 80 | Depth + FAQ schema + links from Medigap cluster (Phase 2) |
| /medicare-coverage/medicare-advantage-vs-medigap | 78 | 1,027 | 78 | Receives links from top asset; expand (Phase 2) |
| /medicare-coverage/understanding-medicare-parts-a-b-c-d | 76 | 910 | 72 | Basics cluster anchor (Phase 2) |
