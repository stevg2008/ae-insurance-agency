...
export default function MedicareParts() {
  return (
    <section className="py-14 bg-[#1A72C0]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16">
          ...
          <AnimatedSection delay={0.1} className="text-center">
            ...
            <h3 className="text-2xl font-bold text-white mb-3">Part A (Hospital)</h3>
            <hr className="border-white/20 mb-4 mx-auto w-32" />
          ...
          <AnimatedSection delay={0.2} className="text-center">
            ...
            <h3 className="text-2xl font-bold text-white mb-3">Part B (Medical)</h3>
            <hr className="border-white/20 mb-4 mx-auto w-32" />
            <p className="text-white text-base leading-relaxed">
