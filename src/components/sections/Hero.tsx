          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              <a
                ...
                className="inline-block border-2 border-[#1A1A2E] text-[#1A1A2E] hover:bg-[#1A72C0] hover:text-white font-bold uppercase tracking-wide text-sm px-7 py-3.5 rounded transition-colors text-center"
              >
                Call {PHONE}
              </a>
            </div>
