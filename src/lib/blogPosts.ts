...
document.querySelectorAll(".faq-question").forEach(button=>{
  ...
  },
  {
    ...
    faqs: [
      ...
      { question: "Are there other Medicare Advantage plans that include UHealth?", answer: "Yes. As of July 2026, plans from Aetna Medicare (HMO and PPO), Humana, Solis Health Plans (Miami area), Optimum HealthCare, and Freedom Health (Broward and Palm Beach) currently include UHealth in their networks, based on our brokerage's plan research. Network participation can change, so always confirm with the plan — and note that Preferred Care Network is currently the only UnitedHealthcare Medicare Advantage plan that includes UHealth." },
    ],
  },
  {
