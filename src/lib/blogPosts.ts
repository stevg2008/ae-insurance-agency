...
document.querySelectorAll(".faq-question").forEach(button=>{
  ...
  },
  {
    ...
    date: "December 2, 2025",
    readTime: "5 min read",
    content: `<figure class="w-richtext-figure-type-image w-richtext-align-fullwidth" style="max-width:400px" data-rt-type="image" data-rt-align="fullwidth" data-rt-max-width="400px"><div><img alt="Top 5 Common Insurance Myths and the Truth Behind Them" src="https://cdn.prod.website-files.com/68c5670ba5d0059b9ef326f9/692e3b13404a690f63d962fd_240_F_415604595_8YrtFQjLRwBbV3MItiFMiLJMHQVfDmTC.jpg" width="auto" height="auto" loading="lazy"></div></figure><p>Insurance is meant to give you peace of mind, but misconceptions often cloud the decision-making process. Let’s debunk five common insurance myths and uncover the truth behind them to help you make informed decisions.</p><h2><strong>Myth 1: "Red Cars Have Higher Insurance Rates"</strong></h2><p>Many people believe that driving a red car will automatically increase their insurance premiums. However, insurers don’t care about the color of your car. Instead, they consider factors like your driving history, the make and model of the car, its age, safety features, and location. So, go ahead and buy that flashy red car without worrying about higher premiums!</p><h2><strong>Myth 2: "Homeowners Insurance Covers All Natural Disasters"</strong></h2><p>Homeowners insurance provides coverage for many risks, but it doesn’t cover everything. For example, standard policies typically exclude damage from floods and earthquakes. If you live in an area prone to such natural disasters, you may need separate policies. Understanding your policy limits can save you from expensive surprises.</p><h2><strong>Myth 3: "You Only Need Life Insurance if You’re Old or Wealthy"</strong></h2><p>Many think life insurance is for retirees or the wealthy, but that’s far from true. Life insurance is critical for anyone with dependents or financial obligations. Whether you’re paying off a mortgage, supporting children, or managing debts, life insurance can protect your loved ones in case of the unexpected. Starting young can also mean lower premiums.</p><h2><strong>Myth 4: "Full Coverage Means Everything is Covered"</strong></h2><p>The term “full coverage” can be misleading. Typically, it includes liability, collision, and comprehensive coverage—but that doesn’t mean all situations are covered. For example, damage from wear and tear, mechanical breakdowns, and certain exclusions like flooding may not be included. Always review your policy to understand what’s covered.</p><h2><strong>Myth 5: "Health Insurance Covers 100% of Medical Expenses"</strong></h2><p>Health insurance is a safety net, but it doesn’t cover every dollar of your medical costs. Most plans include deductibles, copayments, and out-of-pocket maximums. Understanding these terms will help you better plan for medical expenses.</p><h3><strong>Conclusion</strong></h3><p>Don’t let myths keep you from making the right insurance decisions. By knowing the truth, you can secure the right coverage and avoid costly mistakes. If you’re unsure about your policies, consult a licensed insurance agent to explore your options.</p><p>Stay informed and stay covered!</p>`,
  },
  {
    slug: "uhealth-preferred-care-network-options-before-september-2026",
    title: "UHealth and Bascom Palmer Patients on Preferred Care Network: Your Options Before September 1",
    excerpt: "As of July 24, UHealth is still expected to leave UnitedHealthcare's Preferred Care Network Medicare Advantage plans on September 1, 2026. If you get care at UHealth, Sylvester, or Bascom Palmer, here are your real options \u2014 explained calmly and honestly by a local Medicare broker...",
    image: "/blog/medicare-plan-review-office.jpg",
    date: "July 24, 2026",
    readTime: "9 min read",
    content: `<figure class="w-richtext-figure-type-image w-richtext-align-fullwidth" style="max-width:1200px"><div><img alt="Steve Germain reviewing Medicare plan options with South Florida clients at the A&amp;E Insurance office" src="/blog/medicare-plan-review-office.jpg" loading="lazy"></div></figure><p><em>Current as of July 24, 2026. This situation is developing — we are monitoring it closely and will update this article as news breaks.</em></p><p>We hoped to have better news by now. As of July 24, it still stands: <strong>UHealth (University of Miami Health System) is expected to go out of network for UnitedHealthcare's Preferred Care Network Medicare Advantage plans on September 1, 2026.</strong> Your coverage at UHealth — including Sylvester Comprehensive Cancer Center and Bascom Palmer Eye Institute — continues as normal through August 31.</p><p>Since we published our <a href="/blogs/uhealth-preferred-care-network-out-of-network-sept-2026">first guide to this dispute</a>, our phones have been busy with the same questions: <em>Can I switch plans now? What if I'm in the middle of treatment? Should I give up my Bascom Palmer doctor?</em> This article walks through the real options, honestly — including the timing rules that most coverage skips over.</p><h2>If You're in Active Treatment Right Now, Start Here</h2><p>If you are being treated for cancer at Sylvester, recovering from surgery, on dialysis, or managing any serious ongoing condition with UHealth doctors, your first move is not switching plans — it's <strong>continuity of care</strong>.</p><p>Continuity of care lets patients in active treatment for a serious or complex condition keep their in-network benefits with UHealth for a limited period after September 1, if UnitedHealthcare approves the request. Requests are reviewed case by case, which is exactly why applying early matters.</p><ol><li>Call the number on the back of your UnitedHealthcare UCard</li><li>Say you want to apply for <strong>continuity of care</strong> for your UHealth providers</li><li>Have your treatment details ready: condition, providers, upcoming appointments and procedures</li><li>Write down the name of who you spoke with and ask how you'll be notified of the decision</li></ol><p><strong>Key takeaway:</strong> If you're in active treatment, apply for continuity of care now — don't wait for September. Approval is not automatic, and early applications leave time to plan if the answer is no.</p><h2>Can I Switch Medicare Advantage Plans Right Now? The Honest Answer</h2><p>Here's the part most people find frustrating, and we'd rather tell you straight: <strong>we are not currently in a Medicare enrollment period, and a hospital leaving your plan's network does not automatically give you the right to switch plans mid-year.</strong></p><p>That said, some people do qualify for a mid-year change through a Special Enrollment Period. The two most common paths we're seeing for Preferred Care Network members:</p><ul><li><strong>If you have Medicare and full Medicaid</strong> (or certain levels of Extra Help), you may have additional enrollment flexibility during the year, depending on your Medicaid level. This is case-by-case — we can check yours in a few minutes.</li><li><strong>If you have a qualifying chronic condition</strong> — such as diabetes or cardiovascular disease — you may be able to enroll in a <strong>Chronic Condition Special Needs Plan (C-SNP)</strong> designed for that condition, if you're not already in one for the same condition. Aetna and other carriers offer C-SNP plans in South Florida that include UHealth in their networks.</li></ul><p>Everyone else's next opportunity is the <strong>Annual Enrollment Period: October 15 – December 7</strong>, with the new plan taking effect <strong>January 1, 2027</strong>.</p><p><strong>Key takeaway:</strong> Whether you qualify to switch before AEP depends on your specific situation — Medicaid status, health conditions, and other factors. A licensed agent can check your eligibility at no cost, and no, you should never drop coverage first and figure it out after.</p><h2>The Timing Gap Nobody Is Explaining: September 1 to January&nbsp;1</h2><p>If you don't qualify for a mid-year switch, there's a four-month window — September through December — where UHealth would be out of network for your plan. During that window, your realistic options are:</p><ul><li><strong>Continuity of care</strong>, if you're approved (see above)</li><li><strong>Temporarily seeing in-network providers</strong> for routine needs, then reassessing your plan during AEP</li><li><strong>Paying out-of-network costs</strong> at UHealth — possible under some plan rules, but often expensive; confirm your plan's out-of-network benefits before assuming this works</li><li><strong>Emergency care at UHealth remains covered regardless</strong> — network rules never apply to true emergencies</li></ul><p>Planning for this gap now — rather than discovering it on September 2 — is most of what our recent consultations have been about.</p><p><em>Not sure which of these applies to you? <a href="/contact">Contact us</a> or call <strong>(954) 281-5622</strong> — checking your options costs nothing.</em></p><h2>Which Plans Include UHealth — and the Baptist Health Detail Worth Knowing</h2><p>Our <a href="/blogs/uhealth-preferred-care-network-out-of-network-sept-2026">first article</a> has the full table of Medicare Advantage plans that include UHealth, built from UHealth's own published list — including which plans cover UHealth specialists but not UM primary care doctors. A few notes from the inquiries we're getting:</p><ul><li><strong>Aetna Medicare Advantage</strong> is drawing the most interest, and for a practical reason: based on our current plan research, many Aetna Medicare Advantage plans in South Florida include <strong>both UHealth and Baptist Health</strong> — two systems a lot of our clients want to keep. Aetna also offers a C-SNP option locally. As always, confirm your specific doctors and plan before enrolling.</li><li><strong>In Broward and Palm Beach</strong>, Freedom Health and Optimum HealthCare are worth checking against your doctor list; <strong>Prominence Health</strong> is an option in Palm Beach.</li><li>Whatever you consider: <strong>check every doctor you see against the plan's directory, not just the hospital.</strong> That's the step people skip, and it's where mid-January surprises come from.</li></ul><p>Naming a plan here is not an endorsement or a recommendation — network participation changes, and the right plan depends on your doctors, medications, and budget. Always confirm directly with the plan.</p><h2>The Bascom Palmer Question: Switch Plans or Switch Eye&nbsp;Doctors?</h2><p>Several callers have asked a version of: <em>"Should I just find another ophthalmologist?"</em> That's a personal decision, and we won't pretend otherwise. But here's a fair way to think it through:</p><ul><li><strong>How specialized is your eye care?</strong> Routine exams and glasses are widely available. Complex retina, glaucoma, or cornea care is a different conversation — Bascom Palmer is, per UHealth, ranked #1 in the nation for eye care, and specialist relationships built over years have real value.</li><li><strong>What's your timeline?</strong> If your next appointment is after January 1, an AEP plan change may solve this without changing doctors at all.</li><li><strong>What does the rest of your care look like?</strong> Don't redesign your whole coverage around one doctor — but don't dismiss what that doctor means to you either. The right answer weighs everything: your physicians, your medications, your budget, your health.</li></ul><h2>Is This the Moment to Consider a Medicare Supplement&nbsp;Instead?</h2><p>Here's a bigger-picture question this dispute has many of our clients asking: <em>should I be on Medicare Advantage at all?</em></p><p><strong>Medicare Supplement (Medigap) plans work alongside Original Medicare — and Original Medicare has no provider networks.</strong> Any doctor or hospital that accepts Medicare, including UHealth, can treat you. Network disputes like this one generally stop being your problem.</p><p>The honest tradeoffs:</p><ul><li><strong>Higher monthly premiums</strong> than most Medicare Advantage plans, in exchange for predictable costs and no networks</li><li><strong>A separate Part D prescription drug plan</strong> is needed — if you switch during AEP, we recommend timing both your Medigap plan and drug plan to take effect January 1 together</li><li><strong>Acceptance may involve medical underwriting.</strong> Switching from Medicare Advantage to Medigap outside your protected enrollment windows usually means the insurer can review your health history in Florida. Depending on your situation, approval is not guaranteed — one more reason to plan this move carefully rather than rush it.</li></ul><p>Our guides on <a href="/blogs/medicare-advantage-vs-medicare-supplement-plans-in-florida-which-is-right-for-you">Medicare Advantage vs. Medicare Supplement in Florida</a> and <a href="/blogs/whats-the-difference-between-medigap-plan-g-vs-plan-n-in-florida">Plan G vs. Plan N</a> cover the details. With AEP starting October 15, now is exactly the right time to assess this calmly — not in a panic, with a full comparison of your options.</p><h2>Frequently Asked Questions</h2><h3>Can I switch Medicare Advantage plans right now because UHealth is leaving my network?</h3><p>Not automatically. A provider leaving your plan's network does not by itself create a Special Enrollment Period. Some people qualify to switch mid-year through other paths — full Medicaid, Extra Help, or a qualifying chronic condition (C-SNP) — and everyone can make changes during the Annual Enrollment Period, October 15 – December 7, effective January 1.</p><h3>I'm receiving cancer treatment at Sylvester. Will I have to stop seeing my doctors on September 1?</h3><p>Not necessarily. Patients in active treatment for a serious or complex condition may be approved for continuity of care, which continues in-network benefits with UHealth for a limited period. Call the number on your UnitedHealthcare UCard and apply early — approval is case by case.</p><h3>What happens if I do nothing before September 1?</h3><p>Your Preferred Care Network plan continues — you keep your coverage and the rest of the plan's network. UHealth facilities and doctors would simply be out of network, meaning higher costs or no coverage for non-emergency UHealth care, depending on your plan's rules. Emergency care at UHealth is always covered.</p><h3>Does a Medicare Supplement plan really avoid this problem?</h3><p>Generally, yes. Medigap plans work with Original Medicare, which has no networks — any provider that accepts Medicare, including UHealth, can treat you. The tradeoffs are higher premiums, a separate drug plan, and possible medical underwriting when switching from Medicare Advantage in Florida.</p><h3>Which Medicare Advantage plans still include UHealth?</h3><p>Per UHealth's published list (July 2026): Aetna, Humana, Solis Health Plans, Optimum HealthCare, Freedom Health, and Prominence Health include UHealth in at least some South Florida counties — with important differences in UM primary care access. See our first article for the full table, and always confirm your specific doctors with the plan.</p><h3>Could UHealth and UnitedHealthcare still reach a deal?</h3><p>Yes. UnitedHealthcare has said it will notify members if an agreement extends network access beyond September 1, and negotiations sometimes resolve close to — or even after — deadlines. We are monitoring this closely and will update both articles the moment there is news.</p><h2>Talk Through Your Options — Free, No Pressure</h2><p>Every situation in this article — continuity of care, mid-year eligibility, plan comparisons, the Medigap question — comes down to your specific doctors, medications, and circumstances. That's a 20-minute conversation, not a guessing game. Call A&amp;E Insurance Agency at <strong>(954) 281-5622</strong> or <a href="/contact">schedule your free consultation</a>. We're local, independent, and we've guided South Florida families through decisions exactly like this one.</p><p><em>We do not offer every plan available in your area. Currently we represent 16 organizations which offer 73 products in your area. Please contact Medicare.gov, 1-800-MEDICARE, or your local State Health Insurance Assistance Program (SHIP) to get information on all of your options.</em></p><p><em>A&amp;E Insurance Agency is an independent insurance agency. We are not affiliated with, endorsed by, or acting on behalf of UHealth, the University of Miami, UnitedHealthcare, or any health system or carrier named above. Plan availability, premiums, benefits, networks, and provider participation can change at any time; confirm details directly with your health plan and providers. Eligibility for any enrollment period is determined case by case. This article is for educational purposes only and does not replace advice from a licensed insurance professional, healthcare provider, or attorney.</em></p>`,
    faqs: [
      { question: "Can I switch Medicare Advantage plans right now because UHealth is leaving my network?", answer: "Not automatically. A provider leaving your plan's network does not by itself create a Special Enrollment Period. Some people qualify to switch mid-year through other paths \u2014 full Medicaid, Extra Help, or a qualifying chronic condition (C-SNP) \u2014 and everyone can make changes during the Annual Enrollment Period, October 15 to December 7, effective January 1." },
      { question: "I'm receiving cancer treatment at Sylvester. Will I have to stop seeing my doctors on September 1?", answer: "Not necessarily. Patients in active treatment for a serious or complex condition may be approved for continuity of care, which continues in-network benefits with UHealth for a limited period. Call the number on your UnitedHealthcare UCard and apply early \u2014 approval is case by case." },
      { question: "What happens if I do nothing before September 1?", answer: "Your Preferred Care Network plan continues \u2014 you keep your coverage and the rest of the plan's network. UHealth facilities and doctors would simply be out of network, meaning higher costs or no coverage for non-emergency UHealth care, depending on your plan's rules. Emergency care at UHealth is always covered." },
      { question: "Does a Medicare Supplement plan really avoid this problem?", answer: "Generally, yes. Medigap plans work with Original Medicare, which has no networks \u2014 any provider that accepts Medicare, including UHealth, can treat you. The tradeoffs are higher premiums, a separate drug plan, and possible medical underwriting when switching from Medicare Advantage in Florida." },
      { question: "Which Medicare Advantage plans still include UHealth?", answer: "Per UHealth's published list (July 2026): Aetna, Humana, Solis Health Plans, Optimum HealthCare, Freedom Health, and Prominence Health include UHealth in at least some South Florida counties \u2014 with important differences in UM primary care access. Always confirm your specific doctors with the plan." },
      { question: "Could UHealth and UnitedHealthcare still reach a deal?", answer: "Yes. UnitedHealthcare has said it will notify members if an agreement extends network access beyond September 1, and negotiations sometimes resolve close to or even after deadlines. We are monitoring closely and will update our coverage the moment there is news." },
    ],
  },
  {
    ...
    faqs: [
      ...
      { question: "Are there other Medicare Advantage plans that include UHealth?", answer: "Yes. According to UHealth's published accepted-plans list (July 2026), Medicare Advantage plans from Aetna, Humana, Solis Health Plans, Optimum HealthCare, Freedom Health, and Prominence Health currently include UHealth — but several include UHealth's specialists and hospitals without including University of Miami primary care doctors, and county availability varies. Network participation can change, so always confirm with the plan. Preferred Care Network is currently the only UnitedHealthcare Medicare Advantage plan that includes UHealth." },
    ],
  },
  {
