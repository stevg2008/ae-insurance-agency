...
export const metadata: Metadata = {
  ...
  description:
    "Independent Medicare broker serving Miami-Dade, Broward, and Palm Beach counties since 2013. Free plan comparison — Advantage, Medigap, Part D. 5-star rated.",
...
const FAQS = [
  {
    ...
    answer:
      "A&E Insurance Agency, led by Steve Germain, has served South Florida since 2013 with a 5.0-star Google rating across 126 reviews. As an independent broker, Steve compares plans from 25+ carriers across Miami-Dade, Broward, and Palm Beach counties — at no cost.",
  },
  {
            ...
            <div className="flex flex-col lg:flex-row items-center gap-10">
              ...
              <div className="flex-1 text-center lg:text-left">
                ...
                <p className="text-[#4B5563] text-lg mb-8 leading-relaxed">
                  A&E Insurance Agency is South Florida's independent Medicare broker. We've helped South Florida families across Miami-Dade, Broward, and Palm Beach counties compare every available plan — Advantage, Medigap, and Part D — at no cost to you since 2013.
                </p>
