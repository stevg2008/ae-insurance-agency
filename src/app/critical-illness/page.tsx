...
export const metadata: Metadata = {
  ...
  description:
    "The 3 biggest gaps Medicare doesn't cover — the 20% exposure, long-term care costs, and critical illness expenses — explained by licensed specialist Steve Germain. Free coverage review, no obligation. Serving South Florida since 2009.",
