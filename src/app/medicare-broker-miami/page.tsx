...
export const metadata: Metadata = {
  ...
  description:
    "Local Medicare broker in Miami since 2009. Steve Germain compares every plan in Miami-Dade at no cost — Advantage, Medigap, Part D. 5-star rated. Free consultation.",
            ...
            <div className="flex flex-col lg:flex-row items-center gap-10">
              ...
              <div className="flex-1 text-center lg:text-left">
                ...
                <p className="text-[#4B5563] text-lg mb-8 leading-relaxed">
                  A&E Insurance Agency has helped Miami families navigate Medicare since 2009. As an independent broker, Steve Germain compares every plan available in Miami-Dade County — Advantage, Medigap, and Part D — at no cost. Same price as going direct.
                </p>
