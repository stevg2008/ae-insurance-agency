    ...
    <div className="bg-white min-h-screen">
      ...
      <section className="py-16 px-4 border-b border-[#E5E7EB]">
        <div className="max-w-5xl mx-auto flex flex-col lg:flex-row gap-12 items-start">
          ...
          >
            <h2 className="text-sm font-extrabold uppercase tracking-widest text-[#0071BB] mb-4 leading-snug">
      ...
      <section className="py-14 px-4 border-b border-[#E5E7EB]">
        <div className="max-w-2xl mx-auto text-center">
          <span className="inline-block text-[#0071BB] font-bold text-xs uppercase tracking-widest mb-3">Free · No Pressure · No Obligation</span>
          ...
          >
            ...
            <div>
              <p className="text-[#1A1A2E]">
                ...
                <a href={`mailto:${EMAIL}`} className="text-[#0071BB] hover:underline">
                  {EMAIL}
                </a>
              </p>
            </div>
            ...
            <div>
              ...
              <div className="flex items-center gap-4">
                ...
                <a href={SOCIAL.facebook} target="_blank" rel="noopener noreferrer"
                  className="text-[#4B5563] hover:text-[#0071BB] transition-colors">
          ...
          >
            <div>
              ...
              <a
                ...
                className="text-[#0071BB] text-lg font-semibold hover:underline"
              >
                {PHONE}
              </a>
            </div>
